...
class AgentGame:
    def __init__(self, AgentClass,
        ...
        self.deadzones = self.allPlayers[0].agent.xau()
    ...
    def executeAction(self, player, action):
        ...
        if costT > 1:
            print(player.name, costT, player.timespent)
    ...
    def show(self):
        ...
        if self.screen != None:
            ...
            for dz in self.deadzones.keys():
                pygame.draw.rect(self.screen, (255,255,4) , (dz[0]*T, dz[1]*T, T, T), 0)
